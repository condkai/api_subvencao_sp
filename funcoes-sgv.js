...
function cadastrarSubvencao(cpf, proposta, valorSubvencao){
  ...
  driver.get(link);
  driver.findElement(By.id("cpfUsuario")).sendKeys("28059024833");
  driver.findElement(By.id("senha")).sendKeys("Mapfre2018");
